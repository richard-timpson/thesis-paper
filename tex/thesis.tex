...
\documentclass[doublespace,nopageskip]{thesis} % nopageskip - Removes arbitrary blank pages.
...
\acknowledge{\input{contents/acknowledgement}}
 

% The abstract is required.
\abstract{Give a brief description of your thesis here.}
\abstract{\input{contents/abstract}}

% The general audience abstract is required. There are currently no word limits.
\abstractgenaud{\input{./contents/generalabstract} }
